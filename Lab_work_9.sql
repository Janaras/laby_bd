...
('Tashieva', 'Janara', 'Jakypovna', 1),
('Ayana', 'Sagynbekova', 'Sagynbekovna', 3),
('Abylova', 'Burulai', 'Jamshitbekovna', 4);
...
VALUES ('2023-02-11', '0001', 'dokument 1', 1, 1, 1, 1, 1),
       ('2023-02-12', '0002', 'dokument 2', 2, 2, 2, 2, 2),
       ('2023-02-13', '0003', 'dokument 3', 3, 3, 3, 3, 3);
...
5)	Поставки по товарам по клиентам за период
...
6)	Изменение цен на товары, поставленные за период
...
7)	Оплата по поставкам (журнал) за период
